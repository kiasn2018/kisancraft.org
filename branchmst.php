...
<form class="form-horizontal well" action="importbranch.php" method="post" name="upload_excel" enctype="multipart/form-data">
<fieldset>
...
<table class="sortable">
        ...
        <tr class="d0">
          ...
          <th width="50%"><span> Branch Name</span></th>
	...
	?>
        <tr class="d1">
			...
			<td><?php echo $row["B_distict"]; ?></td>
			<td><a href="/kisankraft.org/editbranch.php?&rowid=<?php echo $row["B_id"]?>" target="blank">View</a> </td>
