...
<html>
   ...
   <body bgcolor="">
      ...
      <div class ="row">
      <div class="col-6" >
      <h1 style="text-align:center;"> Upload Bank Transaction</h1>
      <div class="col-12 stretch-card">
         <div class="card">
            <div class="card-body">
               <form class="forms-sample" action="importbank.php" method="post" name="upload_excel" enctype="multipart/form-data">
