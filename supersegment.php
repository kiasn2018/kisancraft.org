...
<form class="form-horizontal well" action="importsegment.php" method="post" name="upload_excel" enctype="multipart/form-data">
<fieldset>
...
<table class="sortable">
          <thead>
        <tr class="d0">
          <th width="50%"><span> Segment</span></th>
          <th width="20%"><span>Super Segment</span></th>      
        </tr>
      </thead>
    <tbody>
	<?php
	...
	?>
        <tr class="d1">
			...
			<td><?php echo $data= $row["supersegment"]; ?></td>
