      ...
      <ul class="nav">
         ...
         <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
               <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                     <a class="nav-link" href="#">Item Wise</a>
                  </li>
                  </li>
                  <li class="nav-item">
         ...
         <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic1">
               <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/aeging.php">Standerd</a>
                  </li>
                  </li>
                  <li class="nav-item">
         ...
         <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic3">
               <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/importtrans.php">Upload Bank Transaction</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="#">Actual</a>
                  </li>
         ...
         <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic6">
               <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/incentivessales.php">Incentives for Sales</a>
                  </li>
                  </li>
                  <li class="nav-item">
         ...
         <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic7">
               <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/suppliermaster.php">Supplier Master</a>
                  </li>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/executive.php">Executive Master</a>
                  </li>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/statemst.php">State Master</a>
                  </li>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="#">State Employee Mapping</a>
                  </li>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/itemid.php">Item Master</a>
                  </li>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/supersegment.php">Super Segment Master</a>
                  </li>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/stockmst.php">Stock Master</a>
                  </li>
                  </li>
                  <li class="nav-item">
         ...
         <li class="nav-item">
            ...
            <div class="collapse" id="auth">
               <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/validation.php">Validation</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/master.php">Sales master</a>
                  </li>
                  <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/uploadcredit.php">Credit Upload</a>
                  </li>
                   <li class="nav-item">
                     <a class="nav-link" href="/kisancraft.org/uploadtrade.php">UPLOAD Trade Discount</a>
                  </li>
                  ...
                  <li class="nav-item"><a class="nav-link" href="/kisancraft.org/salesemp.php">Sales WRT Employees</a></li>
                  <br>
