...
<form class="form-horizontal well" action="importledger.php" method="post" name="upload_excel" enctype="multipart/form-data">
<fieldset>
...
<table class="sortable">
        ...
        <tr class="d0">
          ...
          <th width="50%"><span> State</span></th>
	...
	?>
        <tr class="d1">
			...
			<td><a href="#<?php echo $row["B_id"]?>" target="blank">Edit</a> </td>
